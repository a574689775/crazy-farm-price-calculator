...
const rawCrops: CropConfig[] = [
  ...
  { name: '番茄', priceCoefficient: 66.22, maxWeight: 10.20, growthSpeed: 33.33, type: '普通' },
  ...
  { name: '梨', priceCoefficient: 484.15, maxWeight: 13.60, growthSpeed: 75, type: '普通' },
  ...
  { name: '棉花', priceCoefficient: 2578.86, maxWeight: 5.20, growthSpeed: 200, type: '普通' },
  { name: '苹果', priceCoefficient: 188.7400, maxWeight: 37.40, growthSpeed: 40.5, type: '普通', specialMutations: ['糖葫芦'] },
  { name: '石榴', priceCoefficient: 527.58, maxWeight: 20.00, growthSpeed: 83.5, type: '普通' },
  ...
  { name: '椰子', priceCoefficient: 145.98, maxWeight: 40.80, growthSpeed: 32.5, type: '普通' },
  { name: '南瓜', priceCoefficient: 12.96, maxWeight: 204.00, growthSpeed: 6.5, type: '普通', specialMutations: ['万圣夜'] },
  ...
  { name: '月灯草', priceCoefficient: 1503.86, maxWeight: 5.10, growthSpeed: 205, type: '月球' },
  { name: '月番茄', priceCoefficient: 662.48, maxWeight: 10.20, growthSpeed: 111, type: '月球' },
  { name: '月环树', priceCoefficient: 322, maxWeight: 20.40, growthSpeed: 58, type: '月球' },
  { name: '银灰苔', priceCoefficient: 3045.29, maxWeight: 5.10, growthSpeed: 280, type: '月球' },
  { name: '月莓', priceCoefficient: 3920.93, maxWeight: 8.5, growthSpeed: 375, type: '月球' },
  ...
  { name: '星空玫瑰', priceCoefficient: 33074.76, maxWeight: 10.2, growthSpeed: 2680, type: '月球' },
]
