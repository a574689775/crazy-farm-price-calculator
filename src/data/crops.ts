...
const rawCrops: CropConfig[] = [
  ...
  { name: '香菇', priceCoefficient: 687.7039, maxWeight: 3.40, growthSpeed: 133, type: '普通' },
  ...
  { name: '黄瓜', priceCoefficient: 215.0412, maxWeight: 13.60, growthSpeed: 50, type: '普通', specialMutations: ['黄瓜蛇'] },
  ...
  { name: '苹果', priceCoefficient: 188.741, maxWeight: 37.40, growthSpeed: 40.5, type: '普通', specialMutations: ['糖葫芦'] },
  ...
  { name: '草莓', priceCoefficient: 8715.784, maxWeight: 8.50, growthSpeed: 888, type: '普通', specialMutations: ['连体'] },
  ...
  { name: '向日葵', priceCoefficient: 370.1761, maxWeight: 51.00, growthSpeed: 80, type: '普通', specialMutations: ['笑日葵'] },
  { name: '松果', priceCoefficient: 4614.5318, maxWeight: 17.00, growthSpeed: 570, type: '普通' },
  { name: '大王菊', priceCoefficient: 24826.708, maxWeight: 10.20, growthSpeed: 2400, type: '普通' },
  { name: '葡萄', priceCoefficient: 24847.8389, maxWeight: 10.20, growthSpeed: 2400, type: '普通' },
  { name: '蟠桃', priceCoefficient:8780.0544, maxWeight: 20.40, growthSpeed: 1333.33, type: '普通' },
  { name: '惊奇菇', priceCoefficient: 49648.1697, maxWeight: 10.20, growthSpeed: 2400, type: '普通' },
  { name: '仙人掌象', priceCoefficient: 9527.811, maxWeight: 34.00, growthSpeed: 720, type: '普通' },
  { name: '魔鬼朝天椒', priceCoefficient: 33144.1529, maxWeight: 10.20, growthSpeed: 2400, type: '普通' },
  // 月球作物
  { name: '月光草', priceCoefficient: 330.8416, maxWeight: 3.40, growthSpeed: 111, type: '月球' },
  { name: '灰壤豆', priceCoefficient: 1352.2327, maxWeight: 3.40, growthSpeed: 180, type: '月球' },
  { name: '月灯草', priceCoefficient: 1503.9184, maxWeight: 5.10, growthSpeed: 205, type: '月球' },
  ...
  { name: '月莓', priceCoefficient: 3920.9258, maxWeight: 8.5, growthSpeed: 375, type: '月球' },
  { name: '星叶菜', priceCoefficient: 3973.0842, maxWeight: 10.2, growthSpeed: 416, type: '月球' },
  { name: '月核树', priceCoefficient: 3388.3993, maxWeight: 17, growthSpeed: 460, type: '月球' },
  { name: '液光藤', priceCoefficient: 3509.9501, maxWeight: 20.4, growthSpeed: 520, type: '月球' },
  { name: '幻月花', priceCoefficient: 8368.9716, maxWeight: 23.8, growthSpeed: 0, type: '月球' },
  { name: '星空玫瑰', priceCoefficient: 33134.5264, maxWeight: 10.2, growthSpeed: 2680, type: '月球' },
]
