...
export const crops: CropConfig[] = [
  { name: '土豆', priceCoefficient: 25, maxWeight: 12.00, weatherMutations: 81, maxPrices: { '普通': 8.52, '银': 25.57, '金': 85.22, '水晶': 170.43, '流光': 255.65 } },
  ...
  { name: '黄瓜', priceCoefficient: 215.16, maxWeight: 13.50, weatherMutations: 81, maxPrices: { '普通': 87.51, '银': 262.54, '金': 875.14, '水晶': 1750.27, '流光': 2625.41 } },
  { name: '西瓜', priceCoefficient: 10.71, maxWeight: 170.00, weatherMutations: 81, maxPrices: { '普通': 194.66, '银': 583.98, '金': 1946.60, '水晶': 3893.20, '流光': 5839.80 } },
  ...
  { name: '苹果', priceCoefficient: 188.6, maxWeight: 37.40, weatherMutations: 81, maxPrices: { '普通': 353.72, '银': 1061.17, '金': 3537.23, '水晶': 7074.45, '流光': 10611.68 } },
  ...
  { name: '香蕉', priceCoefficient: 2484.51, maxWeight: 10.20, weatherMutations: 81, maxPrices: { '普通': 663.67, '银': 1991.02, '金': 6636.74, '水晶': 13273.48, '流光': 19910.22 } },
  ...
  { name: '南瓜', priceCoefficient: 12.9, maxWeight: 205.00, weatherMutations: 81, maxPrices: { '普通': 310.48, '银': 931.44, '金': 3104.81, '水晶': 6209.61, '流光': 9314.42 } },
  { name: '草莓', priceCoefficient: 8709.29, maxWeight: 8.50, weatherMutations: 81, maxPrices: { '普通': 1769.80, '银': 5309.41, '金': 17698.03, '水晶': 35396.07, '流光': 53094.10 } },
