...
const rawCrops: CropConfig[] = [
  ...
  { name: '幻月花', priceCoefficient: 8366.0613, maxWeight: 23.8, growthSpeed: 1142.5, type: '月球' },
  ...
  { name: '月影梅', priceCoefficient: 77261.9836, maxWeight: 3.40, growthSpeed: 4000, type: '月球' },
]
