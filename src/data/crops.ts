...
export const crops: CropConfig[] = [
  { name: '土豆', priceCoefficient: 25, maxWeight: 12.00, specialMutations: ['薯片'] },
  { name: '香菇', priceCoefficient: 688.53, maxWeight: 3.45 },
  { name: '番茄', priceCoefficient: 66.24, maxWeight: 10.20 },
  { name: '波斯菊', priceCoefficient: 43.54, maxWeight: 34.20 },
  { name: '大豆', priceCoefficient: 2500, maxWeight: 3.50 },
  { name: '竹子', priceCoefficient: 12.24, maxWeight: 135.00 },
  { name: '黄瓜', priceCoefficient: 215.06, maxWeight: 13.50, specialMutations: ['黄瓜蛇'] },
  { name: '西瓜', priceCoefficient: 10.71, maxWeight: 170.00, specialMutations: ['方形'] },
  { name: '梨', priceCoefficient: 486.86, maxWeight: 13.60 },
  { name: '橘子', priceCoefficient: 539.35, maxWeight: 13.50 },
  { name: '玉米', priceCoefficient: 100, maxWeight: 40.80 },
  { name: '白菜', priceCoefficient: 579.72, maxWeight: 10.20 },
  { name: '牵牛花', priceCoefficient: 2100, maxWeight: 5.20 },
  ...
  { name: '椰子', priceCoefficient: 145, maxWeight: 41.20 },
  { name: '南瓜', priceCoefficient: 12.9, maxWeight: 205.00, specialMutations: ['万圣夜'] },
  { name: '草莓', priceCoefficient: 8709.29, maxWeight: 8.50, specialMutations: ['连体'] },
  { name: '猕猴桃', priceCoefficient: 2100, maxWeight: 13.50 },
  { name: '荔枝', priceCoefficient: 790.2, maxWeight: 24.50 },
  { name: '榴莲', priceCoefficient: 790.19, maxWeight: 61.50 },
  { name: '向日葵', priceCoefficient: 370.32, maxWeight: 51.00, specialMutations: ['笑日葵'] },
  { name: '松果', priceCoefficient: 4600, maxWeight: 17.00 },
  { name: '大王菊', priceCoefficient: 24827.03, maxWeight: 10.20 },
  { name: '葡萄', priceCoefficient: 24832.04, maxWeight: 10.20 },
